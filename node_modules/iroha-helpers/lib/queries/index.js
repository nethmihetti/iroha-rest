...
function getRawAccount(queryOptions, _ref3) {
...
function getSignatories(queryOptions, _ref4) {
...
function getTransactions(queryOptions, _ref5) {
  var txHashesList = _ref5.txHashesList;
...
function getAccountTransactions(queryOptions, _ref6) {
...
function getAccountAssetTransactions(queryOptions, _ref7) {
  var accountId = _ref7.accountId,
      assetId = _ref7.assetId,
      pageSize = _ref7.pageSize,
      firstTxHash = _ref7.firstTxHash;
...
function getAccountAssets(queryOptions, _ref8) {
...
function getAccountDetail(queryOptions, _ref9) {
  var accountId = _ref9.accountId,
      key = _ref9.key,
      writerId = _ref9.writerId;
...
function getAssetInfo(queryOptions, _ref10) {
...
function getRolePermissions(queryOptions, _ref11) {
  var roleId = _ref11.roleId;
...
function getBlock(queryOptions, _ref12) {
